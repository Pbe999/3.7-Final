...
let newNums = nums; //newNums becomes nums

newNums[0] = 12; //the 0 intiger "5" becomes 12
...
//only changes one of the arrays and not the other

//option 2: make a shallow copy

//(only works for 1d arrays)
//does not allow you to manipulate each item as you
//you cabbot edit items as you copy them over
//add it to the new list, but is faster

let ages = [5, 4, 3, 2, 1];

let newAges = [...ages]; //must have 3 dots //creates a shallow copy//makes a copy that disassociated
...
function compareArrays(arr) {
    ...
    function compareArrays(arr) {
        ...
        console.log('originalArray: ' + arr);//works for any original array
